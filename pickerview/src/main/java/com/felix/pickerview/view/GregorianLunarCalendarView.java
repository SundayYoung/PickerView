        ...
        if (isGregorian) {
            if (this.mDisplayYearsGregorian == null) {
                ...
                for (int i = 0; i < YEAR_SPAN; i++) {
                    this.mDisplayYearsGregorian[i] = (String.valueOf(YEAR_START + i) + "年");
                }
            }
            if (this.mDisplayMonthsGregorian == null) {
                this.mDisplayMonthsGregorian = new String[12];
                for (int i = 0; i < 12; i++) {
                    this.mDisplayMonthsGregorian[i] = (String.valueOf(1 + i) + "月");
                }
            }
            if (this.mDisplayDaysGregorian == null) {
                this.mDisplayDaysGregorian = new String[31];
                for (int i = 0; i < 31; i++) {
                    this.mDisplayDaysGregorian[i] = (String.valueOf(1 + i) + "日");
                }
            }
        } else {
